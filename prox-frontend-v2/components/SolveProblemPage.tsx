            ...
            <div className="flex items-center gap-4">
              ...
              <div>
                <div className="flex items-center gap-2">
                  <h1 className="text-2xl font-light text-white">Solve a Problem</h1>
                  <span className="px-2 py-0.5 text-xs font-medium bg-white/20 text-white rounded-full">beta</span>
                </div>
                <p className="text-white/80 text-sm">Fix what's been bothering you</p>
              </div>
            </div>
          </div>
        </div>
            ...
            <div className="h-full grid grid-cols-1 lg:grid-cols-5 gap-6">
              ...
              <div className="lg:col-span-3 min-h-[32rem]">
                <ChatInterface
                  ...
                  initialPrompt="I have a problem to solve"
                />
              </div>
