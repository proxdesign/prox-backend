...
export default function QuickFixPage() {
  ...
  const [context, setContext] = useState({ space: '', challenge: '', size: '', budget: 'Under $30' });
  ...
  const handleChatSend = async (message: string) => {
    ...
    setTimeout(() => {
      setMessages(prev => [...prev, {
        role: 'assistant',
        content: `I understand you're looking for help with: "${message}". Let me find some quick solutions under $30 for you.`
      }]);
      setIsLoading(false);
    }, 1000);
  };
            ...
            <div className="h-full grid grid-cols-1 lg:grid-cols-5 gap-6">
              ...
              <div className="lg:col-span-3 min-h-[32rem]">
                <ChatInterface
                  ...
                  initialPrompt="I need a quick fix under $30"
                />
              </div>
